...
interface PinDetailPropTypes {
  user: userType;
}

const PinDetail: FC<PinDetailPropTypes> = ({ user }) => {
      ...
      >
        ...
        <div className="w-full p-5 flex-1 xl:min-w-620">
          <div className="flex items-center justify-between">
            ...
            >
              {pinDetails?.destination.slice(8, 30)}...
            </a>
          </div>
          <div>
          ...
          <div className="max-h-370 overflow-y-auto">
            {pinDetails?.comments?.map((comment: any, idx: string) => {
              return (
                <div
                  key={idx}
                  className="flex gap-2 mt-5 items-center bg-white rounded-lg"
          ...
          <div className="flex flex-wrap mt-6 gap-3">
            ...
            <button
              ...
              onClick={addComment}
            >
              {addingComment ? "Postring the comment..." : "Post"}
            </button>
          </div>
        </div>
      </div>
